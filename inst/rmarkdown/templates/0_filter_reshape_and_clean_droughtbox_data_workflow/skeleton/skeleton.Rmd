...
#[sp_name]_dry_weights <-
    ...
    [sp_name]_main_spread_sheet %>% 
        ...
        mutate(sample_dry_weight_g =  hook_weight_g + weight_paper_bag_plus_sample_scale_grams -
...
```{r plot_cleaned_data_with_dry_weights_no_vpd_control, eval=FALSE, fig.width = 16, fig.height = 14, cache=TRUE}
...
```{r plot_cleaned_data_with_dry_weights_vpd_controlled,eval=FALSE, fig.width = 16, fig.height = 14, cache=TRUE}
...
save([sp_name]_rwc_data, file = "./processed_data/[sp_name]_droughtbox_data_for_rwc.RData")
```
