...
## Crop images for calculating surface area
...
def crop_images_for_imagej(path, blur = 25):
    ...
    # Save ImageJ code as TXT --------------------------------------------------
    # Create file
    imagej_file = open(f"../leaf_area_300dpi.txt", "x")

    # Write code to file
    imagej_file.write('''

        // Run this code by Opening ImageJ

        // Then go to Plugins -> Macros -> Run -> Select leaf_area_300dpi.txt
    ...
    # Close file
    imagej_file.close()
    print(f'Code for ImageJ created')
```
