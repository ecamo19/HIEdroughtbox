...
#[sp_name]_areas_data <-
    ...
    separate(file_name_clean, 
            into = c("image", "genera", "specie", "month", "tree_id", 
                    "set_temperature", "organ", "image_number"),
            sep = "_") %>%

    # Select and reorder columns as desired
    select(image, genera, specie, month, tree_id, vpd_control, 
            set_temperature, organ, image_number, area) %>% 
