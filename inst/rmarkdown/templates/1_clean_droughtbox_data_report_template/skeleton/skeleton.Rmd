...
[sp_name]_reshaped_data <- 
    ...
    reshape_droughtbox_data([sp_name]_merged_cleaned_data)
        ...
        # Remove strings
        #filter(!c(temperature_measured == 30 & string_number == 4)) %>% 
        #filter(!c(temperature_measured == 35 & string_number == 4)) %>%
        #filter(!c(temperature_measured == 40 & string_number == 4)) %>% 
        #filter(!c(temperature_measured == 50 & string_number == 3))    
```     
...
```{r, eval=FALSE}
save([sp_name]_reshaped_data, "/processed_data/[sp_name]_reshaped_droughtbox_data.RData")
```
