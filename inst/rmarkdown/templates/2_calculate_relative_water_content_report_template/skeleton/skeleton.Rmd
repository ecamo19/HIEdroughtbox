...
```{r, eval=FALSE}
# Check data
any([sp_name]_c_reshaped$temperature_measured < 40 | [sp_name]_c_reshaped$temperature_measured >  40)
```
...
```{r, eval=FALSE}
# Check data
any([sp_name]_c_reshaped$temperature_measured < 45 | [sp_name]_c_reshaped$temperature_measured >  45)
```
...
```{r, eval=FALSE}
# Check data
any([sp_name]_c_reshaped$temperature_measured < 50| [sp_name]_c_reshaped$temperature_measured > 50)
```
...
[sp_name]_merged_cleaned_data <- 
                    merge_droughtbox_data([sp_name]_25c_reshaped,
...
[sp_name]_reshaped_data <- 
    ...
    inner_join([sp_name]_merged_cleaned_data, 
...
ggplot(data = [sp_name]_reshaped_data, aes(x = date_time,
    ...
    geom_hline(data = [sp_name]_reshaped_data, 
