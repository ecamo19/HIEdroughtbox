...
```{r eval=FALSE}
newdata <- tibble(temp = seq(min([spcode]_string_NUMBER_data$temp), 
...
```{r, eval=FALSE}
thermal_parameters_string_NUMBER <- 
  model_stack_string_NUMBER %>%
...
save(thermal_parameters_string_NUMBER, 
    file = "./[spcode]_processed_data/[spcode]_string_NUMBER_rtpc_param_values.RData")
