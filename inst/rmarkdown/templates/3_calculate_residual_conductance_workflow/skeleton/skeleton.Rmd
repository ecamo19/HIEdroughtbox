...
[sp_name]_residual_conductance %>%
    ...
    # Summarize data
    summarise(
        median_residual_conductance = median(double_sided_residual_conductance_micro_mol_s_m2),
        sd_residual_conductance = sd(double_sided_residual_conductance_micro_mol_s_m2),
