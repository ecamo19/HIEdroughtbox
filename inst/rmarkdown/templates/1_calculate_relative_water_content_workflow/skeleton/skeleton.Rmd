...
```{r, eval=FALSE}
# ggplot(data = [sp_name]_25c_reshaped, aes(x = time_seconds,
...
```{r, eval=FALSE}
# ggplot(data = [sp_name]_35c_reshaped, aes(x = time_seconds,
#                                            y = string_weight_grams,
#                                            colour = factor(string_number))) +
#   
#     geom_point()+
...
```{r, eval=FALSE}
# ggplot(data = [sp_name]_40c_reshaped, aes(x = time_seconds,
#                                            y = string_weight_grams,
#                                            colour = factor(string_number))) +
#   
#     geom_point()+
...
```{r, eval=FALSE}
# ggplot(data = [sp_name]_45c_reshaped, aes(x = time_seconds,
#                                            y = string_weight_grams,
#                                            colour = factor(string_number))) +
#   
#     geom_point()+
...
```{r, eval=FALSE}
# ggplot(data = [sp_name]_50c_reshaped, aes(x = time_seconds,
#                                            y = string_weight_grams,
#                                            colour = factor(string_number))) +
#   
#     geom_point()+
...
```{r, eval=FALSE}
# ggplot(data = [sp_name]_55c_reshaped, aes(x = time_seconds,
#                                            y = string_weight_grams,
#                                            colour = factor(string_number))) +
#   
#     geom_point()+
