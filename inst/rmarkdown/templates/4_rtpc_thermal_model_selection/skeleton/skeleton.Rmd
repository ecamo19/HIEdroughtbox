...
knitr::opts_chunk$set(autodep        = TRUE,
                      ...
                      fig.path       = paste0("./figures_tpc_model_selection_[spcode]", "/"),
                      fig.width      = 11,
                      fig.height     = 7,
                      message        = FALSE,
                      warning        = FALSE)
...
#models_fits_string_NUMBER <- 
    nest(euc_tere_eucface_string_4_data, data = c(temp, rate)) %>%
    mutate(
      ...
      {print("6) Hinshelwood model done"); .},
